...
1. [language.md](./language.md) — M1 surface syntax
...
6. Error codes: `PARSE-001`, `PARSE-002`, `TYPE-001`, `TYPE-002`, `TYPE-003`, `TYPE-004` in `packages/diag/src/index.ts`; `PATCH-001` from `@forgeir/patch`
