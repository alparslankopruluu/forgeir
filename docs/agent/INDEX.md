...
6. Error codes: `PARSE-001`, `PARSE-002`, `TYPE-001`–`TYPE-004`, `EFFECT-001`, `EFFECT-002`, `EXTERN-001`, `USE-001`–`USE-004` in `packages/diag/src/index.ts`; `PATCH-001` from `@forgeir/patch`
